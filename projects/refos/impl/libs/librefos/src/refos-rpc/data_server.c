...
void server_data_open(void *rpc_userptr) {
    ...
    rpc___ret__ = data_open_handler(rpc_userptr, rpc_name, rpc_flags, rpc_mode, rpc_size, rpc_errno);

    reply_data_open(rpc_userptr, rpc_errno, rpc___ret__);
}

void reply_data_open(void *rpc_userptr, int* rpc_errno, seL4_CPtr rpc___ret__) {
